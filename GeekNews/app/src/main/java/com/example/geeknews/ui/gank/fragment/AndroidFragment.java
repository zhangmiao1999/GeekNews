...
public class AndroidFragment extends BaseFragment<AllView, AndroidPresenter> implements AllView<GankItemBean> {
    ...
    protected void initView() {
        ...
        mAdapter = new AndroidRvAdapter(new ArrayList<GankItemBean.ResultsBean>());
