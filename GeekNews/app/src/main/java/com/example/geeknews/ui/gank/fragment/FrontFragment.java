...
import com.example.geeknews.ui.gank.adapter.FrontRvAdapter;
...
public class FrontFragment extends BaseFragment<AllView, AndroidPresenter> implements AllView<GankItemBean> {
    ...
    private int mNum = 10;
    private int mPage = 1;
    private FrontRvAdapter mAdapter;
    ...
    protected void initView() {
        ...
        mAdapter = new FrontRvAdapter(new ArrayList<GankItemBean.ResultsBean>());
